...
import {Avatar, Button, Card, Checkbox, Label, TextInput} from "flowbite-react";
...
export default function () {
	return (
		<>
			...
			<Card className="max-w-sm sm:max-w-[28rem] md:max-w-[40rem] lg:max-w-screen-lg mx-auto my-20">
				...
				<form className="flex flex-col gap-4">
					<div className="flex flex-col">
						...
						<input type="text"
								 className="px-4 pt-2 pb-[14rem] border focus:ring-gray-500 focus:border-gray-900 w-full sm:text-sm border-gray-300 rounded-md focus:outline-none text-gray-600"
