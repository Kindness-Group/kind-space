			...
			<footer className="px-6 pb-6 flex justify-between">
				<div className="flex gap-10">
					...
					<div className="flex">
						...
						<a href="#" className="uppercase font-bold self-center text-sm text-gray-600 hover:underline">Comments ({actCommentComments})</a>
					</div>
				</div>
				<div className="flex space-x-3 items-center">
					<img src="/heart-icon-cropped.png" className="w-6" alt="heart icon"/>
					<p className="text-sm text-gray-900">
						<span className="font-bold">{actLikeLikes}</span> People loved this Post!
					</p>
				</div>
			</footer>
		</section>
