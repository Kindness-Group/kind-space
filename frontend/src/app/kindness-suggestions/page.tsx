...
export default function DailySuggestionPage() {
    ...
    let suggestion: Suggestion[] = [
        {content: 'Leave an Encouraging Note: Write a short, uplifting note (like "You are amazing!" or "Keep going, you\'ve got this!") and leave it somewhere for a stranger to find—on a park bench, a car windshield, or inside a library book.',
        date: '03/02'},
        {content: 'Compliment a Stranger: Give a genuine compliment to someone you don’t know—tell a barista they made a great coffee, let a coworker know their outfit looks nice, or appreciate someone’s kindness.',
        date: '03/03'},
        {content: "Leave an encouraging note for a stranger on a park bench or in a library book. Write something like, 'You are amazing!' or 'Keep going, you’ve got this!' It can be a simple, positive message that brightens someone's day unexpectedly. Sometimes, a little surprise positivity can make all the difference for someone going through a tough time.",
        date: "03/04"},
        {content: "Compliment a colleague or stranger on something you genuinely appreciate about them. Whether it’s their smile, their work ethic, or their outfit, a sincere compliment can lift someone's spirits. We often forget how much a little praise can help someone feel valued and appreciated.",
        date: "03/05"},
        {content: "Hold the door open for someone who has their hands full. It could be a parent with a stroller or someone carrying heavy bags. A small act like this shows kindness and helps make someone’s day a little easier.",
         date: "03/06"},
        {content: "Pay for the person behind you in line at the coffee shop or drive-thru. It’s a simple but impactful gesture that shows generosity. The person behind you may be surprised and grateful, and it could inspire them to pay it forward.", date: "03/07"},
        {content: "Give a genuine thank-you to someone who often goes unnoticed for their hard work. Maybe it’s the janitor at your workplace or the person who always helps you in the store. Acknowledging their effort can make them feel appreciated and remind them that their hard work matters.",
        date: "03/08"},
        ...
        date: "03/09"},
        {content: "Help a neighbor carry their groceries to their door. This small act of kindness can be especially helpful for elderly neighbors or those who struggle with heavy bags. It fosters a sense of community and shows that you care about the well-being of others around you.",
        date: "03/10"},
        ...
        date: "03/11"},
        {content: "Donate clothes or household items you no longer need to a local charity. Go through your closet and give away things that are in good condition but that you no longer use. Donating to those in need helps make your space more organized and can provide comfort to someone who may be struggling.",
        date: "03/12"},
        {content: "Smile at a stranger as you pass by on the street. A warm smile can be contagious, and sometimes all someone needs is a simple sign of friendliness. It can brighten a person's day and remind them that kindness exists everywhere.",
        date: "03/13"},
        {content: "Offer to help a coworker with a task they’re struggling with. It could be a project they’re overwhelmed by or a deadline they’re racing against. Helping out not only eases their load but also builds stronger relationships and a sense of teamwork in the workplace.",
        date: "03/14"},
        {content: "Give someone an unexpected compliment about their work or effort. Maybe a friend just finished a tough project or a colleague went above and beyond. Taking the time to recognize their hard work shows that you see and appreciate their efforts, boosting their confidence.",
        date: "03/15"},
        {content: "Send a handwritten thank-you note to someone who has made a difference in your life. It could be a mentor, a teacher, or a friend who has supported you through tough times. A heartfelt note can express your gratitude in a personal, memorable way.",
        date: "03/16"},
        {content: "Give a small gift or a homemade treat to a friend or neighbor. It doesn’t have to be something big, but a thoughtful gesture can show you care. Whether it’s cookies, a small plant, or a framed photo, giving something with no expectation in return can spread joy.",
        date: "03/17"},
        {content: "Plant a tree or flower in your community to brighten the environment. Whether it’s in a public park or your own backyard, planting something that will grow and bring beauty to others is a gift to both the earth and your community. It’s a lasting way to make the world a little more beautiful.",
        date: "03/18"}
    ]
