...
export default function DailySuggestionPage() {
   ...
   const [todaySuggestion, setTodaySuggestion] = useState<Suggestion | null>(null);
    ...
    useEffect(() => {
        ...
        const matchingSuggestion = suggestion.find(suggestion => suggestion.suggestionDate === todayDate);
        setTodaySuggestion(matchingSuggestion || null);
        const matchingMoreSuggestions = moreSuggestion.filter(element => element.suggestionDate === todayDate);
