...
export default function Home() {
    return (
        <>
            <section id="welcome-section" className="text-white p-24 relative w-full h-screen">
                ...
                <div className="relative z-10">
                    ...
                    <p className="text-center text-lg p-8">Leaves a smile on your face</p>
...
<section>
    <div id="purpose" className="py-16 bg-white text-black">
        <h1 className="md:text-4xl text-2xl text-center font-bold">Our Purpose</h1>
        <p className="text-center max-md:text-sm md:pt-12 container mx-auto">Kind-Space is a social media platform designed to inspire and amplify kindness! On the Kindness Feed, you can post details of random acts of kindness you’ve experienced or observed, tagging your location on our interactive map. Each act is marked with a heart as kindness spreads in different areas. Our daily kindness suggestions give you ideas each day for making the world a better place.</p>
        <p className="text-center max-md:text-sm md:py-6 container mx-auto">By fostering a culture of positivity and connection, Kind-Space hopes to transform everyday moments into a collective movement of compassion!</p>
        <Button color={"light"} className="m-auto focus:ring-4 focus:ring-purple-700 hover:ring-4 hover:ring-purple-700">Share Kindness</Button>
            ...
            <section>
                <div id="feed-preview" className="py-16 bg-white text-black">
